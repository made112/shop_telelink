...
Route::get('/info/server', function () {
    phpinfo();
});
...
Route::get('/image/resize', 'AizUploadController@resize');
...
Route::post('/home/section/sponsored_products', 'HomeController@load_sponsored_product_section')->name('home.section.sponsored_products');
...
Route::get('webview/seller/{id}', 'Api\AuthController@login_seller');
...
Route::get('/shops/uno', 'HomeController@uno')->name('shop.uno');
Route::get('/shops/uno/{type}', 'HomeController@filter_uno_shop')->name('shop.uno.type');
...
Route::group(['middleware' => ['checkout']], function () {
    ...
    Route::get('/checkout-delivery', 'CheckoutController@get_delivery_info')->name('checkout.delivery_info');
...
// Visa Start
Route::any('visa/payment/done', 'VisaController@getResult');
//Route::get('/payments/pay/callback', 'JawwalPayController@notify');
Route::get('/jawwal/payment/done', 'JawwalPayController@checkout_done');
//Stripe END
...
Route::group(['middleware' => ['user', 'verified_phone']], function () {
...
Route::get('/order/mallchat/done/{order_id}', function ($order_id) {
    $order = \App\Order::findOrFail($order_id);
    return view('webview.order_success', compact('order'));
})->name('maalchat.done');

Route::get('/order/mallchat/cancel', function () {
    return view('webview.cancel');
})->name('maalchat.cancel');

//Route::get('bisan'."/item", 'BisanController@fetchProducts');
//Route::get('bisan'."/itemCategory", 'BisanController@fetchItemCategories');
//Route::get('bisan/itemClassification', 'BisanController@fetchClassification');
//Route::get('bisan'."/itemBrand", 'BisanController@fetchBrand');
//Route::get('bisan'."/unit", 'BisanController@fetchUnit');
//Route::get('bisan'."/currency", 'BisanController@fetchCurrency');
//Route::get('bisan'."/customer", 'BisanController@createCustomer');
//Route::get('bisan'."/product", 'BisanController@createProduct');
//Route::get('bisan'."/order", 'BisanController@createOrder');
//Route::get('/bisan/login', 'BisanController@loginWithBisan');
//Route::get('/bisan/price', 'BisanController@fetchPrice');
//Route::get('/test/test', function () {
//    $test = new \Jawwalpay\RestApi\JawwalPay();
//    return $test->getToken();
//});
Route::get('/test/order', function () {
    $test = new \Jawwalpay\RestApi\JawwalPay();
    return $test->registerOrder();
});
Route::get('/test/payment', function () {
    $test = new \Jawwalpay\RestApi\JawwalPay();
    return $test->payment_key();
});
