...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin', 'hasPermission']], function(){
	...
	Route::get('/bisan/configure', 'BusinessSettingsController@bisan_settings')->name('bisan.configure');
	Route::get('/bisan/export-products', 'BisanController@export_products')->name('bisan.export_products');
	Route::get('/bisan/export-orders', 'BisanController@export_orders')->name('bisan.export_orders');
    ...
    Route::post('/your-unit/update', 'UnitController@updateYourUnit')->name('your_unit.update');
    Route::post('/unit/store', 'UnitController@store')->name('unit.store');
    Route::post('/unit/unit_edit', 'UnitController@edit')->name('unit.edit');
    Route::post('/unit/update_status', 'UnitController@update_status')->name('unit.update_status');
    ...
    Route::get('/vendor_levels', 'BusinessSettingsController@vendor_levels')->name('business_settings.vendor_levels');
    Route::post('/vendor_levels_update', 'BusinessSettingsController@vendor_levels_update')->name('business_settings.vendor_levels.update');
	...
	Route::group(['prefix' => 'frontend_settings'], function(){
	    ...
	    Route::post('/home_categories/updateOrder', 'HomeCategoryController@updateOrder')->name('home_categories.updateOrder');
    ...
    Route::resource('sponsored_products','SponsoredProductController');
    Route::get('/sponsored_products/destroy/{id}', 'SponsoredProductController@destroy')->name('sponsored_products.destroy');
    Route::post('/sponsored_products/update_status', 'SponsoredProductController@update_status')->name('sponsored_products.update_status');
    Route::post('/sponsored_products/update_featured', 'SponsoredProductController@update_featured')->name('sponsored_products.update_featured');
    ...
    Route::post('/sales/update_delivery_status', 'OrderController@update_sale_delivery_status')->name('sales.update_delivery_status');
    Route::post('/sales/update_payment_status', 'OrderController@update_sale_payment_status')->name('sales.update_payment_status');
...
//	Sync Data With
    Route::get('/sync-data-with-bisan', function () {
        \Illuminate\Support\Facades\Artisan::call('products:sync');
        flash('Sync Data successfully')->success();
        return back();
    })->name('sync_with_bisan');
	...
	Route::get('/in_house_sale_report_pdf', 'ReportController@in_house_sale_report_pdf')->name('in_house_sale_report.download');
	Route::get('/seller_report', 'ReportController@seller_report')->name('seller_report.index');
	Route::get('/cancelled_orders_report', 'ReportController@cancelled_orders')->name('cancelled_orders.index');

    Route::get('/products_bisan_export', 'ReportController@products_bisan_export')->name('products_bisan_export.download');
    Route::get('/orders_bisan_export', 'ReportController@orders_bisan_export')->name('orders_bisan_export.download');
    Route::get('/seller_selling_excel', 'ReportController@seller_selling_excel')->name('seller_selling_excel.download');
    Route::get('/order_customer_excel', 'ReportController@order_customer_excel')->name('order_customer_excel.download');
    Route::get('/best_categories_export', 'ReportController@best_categories_export')->name('best_categories.download');
    Route::get('/products_sales_export', 'ReportController@products_sales_export')->name('products_sales.download');

	Route::get('/seller_report_export', 'ReportController@seller_report_export')->name('seller_report.download');
	Route::get('/cancelled_orders_export', 'ReportController@cancelled_orders_export')->name('cancelled_orders.download');
	Route::get('/stock_report_export', 'ReportController@stock_report_export')->name('stock_report.download');
	Route::get('/seller_sale_report_export', 'ReportController@seller_sale_report_export')->name('seller_sale_report.download');
	Route::get('/wish_report_export', 'ReportController@wish_report_export')->name('wish_report.download');
	Route::get('/preferred_products_export', 'ReportController@preferred_products_export')->name('preferred_products.download');
	Route::get('/in_house_sale_report_export', 'ReportController@in_house_sale_report_export')->name('in_house_sale_report.download');
    ...
    Route::get('/sales_report', 'ReportController@sales_report')->name('sales_report.index');
    Route::get('/preferred-products', 'ReportController@preferred_products')->name('preferred_products.index');
    Route::get('/best-categories', 'ReportController@best_categories')->name('best_categories.index');
    ...
    Route::post('/cities/shipping_type', 'CityController@shipping_type')->name('cities.shipping_type');
    Route::post('/cities/free_shipping', 'CityController@free_shipping')->name('cities.free_shipping');
    Route::post('/cities/editCity', 'CityController@editCity')->name('cities.editCity');
