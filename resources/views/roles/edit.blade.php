            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Sponsored Products') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Bisan System') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Offline Payment System') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Club Point System') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
                        ...
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('OTP System') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
...
{{--                        </div>--}}
                        <div class="row">
                            <div class="col-sm-10">
                                <label class="control-label">{{ translate('Refund Request') }}</label>
                            </div>
                            <div class="col-sm-2">
                                <label class="switch">
