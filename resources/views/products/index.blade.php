...
@section('content')
    ...
    {{--                            </div>--}}
                                ...
                                @if ($type == 'Seller')
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('products.seller.edit', encrypt($product->id))}}">
                                        <i class="las la-edit"></i>
                                    </a>
                                @else
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('products.admin.edit', encrypt($product->id))}}">
                                        <i class="las la-edit"></i>
                                    </a>
                                @endif
                                <a class="btn btn-soft-success btn-icon btn-circle btn-sm" href="{{route('products.duplicate', $product->id)}}" title="{{ translate('Duplicate') }}">
                                    <i class="las la-copy"></i>
                                </a>
                                <a href="#" onclick="confirm_modal('{{route('products.destroy', $product->id)}}');" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('products.destroy', $product->id)}}" title="{{ translate('Delete') }}">
