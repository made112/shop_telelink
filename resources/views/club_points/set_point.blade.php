                                    ...
                                    <td>
                                        <a href="{{ route('product', $product->slug) }}" target="_blank" class="media-block">
                                            <div class="media-left">
                                                <img loading="lazy"  class="img-md" src="{{ my_asset($product->thumbnail_img)}}" alt="{{__('Image')}}">
                                            </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <small>{{__("Set any specific point for those products what are between 'min price' and 'max price'. Min-price should be less than Max-price")}}</small>
                    </div>
