        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{{__('BULKSMS OTP')}}</h3>
                </div>
                <div class="panel-body text-center">
                    <label class="switch">
                        <input type="checkbox" onchange="updateSettings(this, 'bulksms')" @if(\App\OtpConfiguration::where('type', 'bulksms')->first()->value == 1) checked @endif>
