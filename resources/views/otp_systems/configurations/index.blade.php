        ...
        <div class="col-lg-6">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">{{__('BULKSMS Credential')}}</h3>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="BULKSMS_URL">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('BULKSMS URL')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULKSMS_URL" value="{{  env('BULKSMS_URL') }}" placeholder="BULKSMS URL" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="types[]" value="BULKSMS_API_TOKEN">
                            <div class="col-lg-3">
                                <label class="control-label">{{__('BULKSMS_API KEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="BULKSMS_API_TOKEN" value="{{  env('BULKSMS_API_TOKEN') }}" placeholder="BULKSMS_API KEY" required>
                            </div>
                        </div>
                        <div class="form-group">
