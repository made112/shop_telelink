          ...
          @csrf
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control demo-select2-placeholder" name="type" id="type" required>
                            ...
                            <option value="qr_code" @if($manual_payment_method->type == 'qr_code') selected @endif>{{__('QR Code')}}</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea name="description" class="editor">{!! $manual_payment_method->description  !!}</textarea>
                    </div>
                </div>
