    ...
    <div style="background: #eceff4;padding: 24px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="text-right small" style="width: 50%;text-align: left"><span class="gry-color small">{{  translate('Order ID') }}:</span>
                    <span class="strong">{{ $order->code }}</span></td>
            </tr>
            <tr>
                <td class="gry-color small">{{ translate('Phone') }}: {{ $generalsetting->phone }}</td>
                <td class="text-right small" style="width: 50%;text-align: left"><span class="gry-color small">{{ translate('Order Date') }}:</span>
                    ...
                    <tr class="">
                        <td>
                            @if(strlen($orderDetail->product->name) > 20)
                                {{ substr($orderDetail->product->name, 0 , 20) }} ...
                            @else
