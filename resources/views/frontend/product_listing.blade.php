                    ...
                    <div class="filter-wrapper c-scrollbar">
                                ...
                                <div class="category-filter">
                                    <ul>
                                        @if(!isset($category_id) && !isset($category_id) && !isset($subcategory_id) && !isset($subsubcategory_id))
                                            @foreach(\App\Category::all()->except('15') as $category)
                        ...
                        @foreach ($attributes as $key => $attribute)
                            @if (\App\Attribute::find($attribute['id']) != null)
                                <div class="bg-white sidebar-box mb-3">
                                    <div class="box-title text-center">
                                        {{translate('Filter by '.\App\Attribute::find($attribute['id'])->name)}}
                                    </div>
                                    <div class="box-content">
                                        <!-- Filter by others -->
                    ...
                    <!-- <div class="bg-white"> -->
                        ...
                        <div class="products-box-bar p-3 bg-white">
                            <div class="row sm-no-gutters gutters-5">
                                            ...
                                            <div class="position-relative overflow-hidden">
                                                <a href="{{ route('product', $product->slug) }}" class="d-block product-image h-100 text-center" tabindex="0">
                                                    <img
                                                        ...
                                                        data-src="{{ my_asset($product->thumbnail_img) }}" alt="{{  __($product->name) }}"
                                ...
                                @endforeach
                                @else
                                    <div class="w-100 d-flex m-auto flex-column justify-content-center align-items-center">
{{--                                        <img class="w-25" src="{{ my_asset('frontend/images/no-message.png') }}" alt="">--}}
                                        <i class="la la-meh-o d-block heading-1 alpha-5" style="font-size: 80px!important;"></i>
                                        <span class="h4" style="font-size: 20px; color: #818a91">{{__('No Data Available')}}</span>
                                        <a href="{{route('products')}}">{{ __('Return To Products') }}</a>
                                    </div>
                                @endif
                            </div>
                        </div>
