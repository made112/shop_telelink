...
@section('meta')
    ...
    <meta itemprop="image" content="{{ my_asset($page->meta_img) }}">
    ...
    <meta name="twitter:image" content="{{ my_asset($page->meta_img) }}">
    ...
    <meta property="og:image" content="{{ my_asset($page->meta_img) }}" />
