                                    ...
                                    @if(Auth::check())
                                        ...
                                        @if($digit_status)
                                            <a href="{{ route('checkout.payment_info') }}"
                                               class="btn btn-styled btn-base-1">{{ translate('Continue to Payment')}}</a>
                                        @else
                                            <a href="{{ route('checkout.delivery_info') }}"
                                               class="btn btn-styled btn-base-1">{{ translate('Continue to Delivery Info')}}</a>
                                        @endif
                                    @else
                                        <button class="btn btn-styled btn-base-1"
                                                onclick="showCheckoutModal()">{{ translate('Continue to Delivery Info')}}</button>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group--style-1">
                                    <input type="tel" id="phone-code" pattern="[0-9]{9}" style="padding-left: 100px"
                                           required
                            ...
                            <div class="form-group">
                                <div class="input-group input-group--style-1 position-relative">
                                    ...
                                    <span class="input-group-addon">
                                        <i class="text-md la la-lock" onclick="showHidePassword(this)"></i>
                                    </span>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function updateQuantity(key, element) {
            $.post('{{ route('cart.updateQuantity') }}', {
                _token: '{{ csrf_token() }}',
                qty: parseInt(element.getAttribute('max')),
                key: key,
