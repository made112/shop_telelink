                ...
                <div class="row cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-8">
                        <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form" method="POST">
                            @csrf
                                <h5>{{translate('Select Shipping Address')}}</h5>
                                @if(Auth::check())
...
{{--                                                            </div>--}}
                            ...
                            <div class="row align-items-center pt-4">
                                ...
                                <div class="col-md-6 text-right">
                                    <button type="submit" class="btn btn-styled btn-base-1">{{ translate('Continue to Payment')}}</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-zoom" role="document">
        <div class="modal-content">
            ...
            <form id="new-address-form" class="form-default" role="form" action="{{ route('addresses.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="p-3">
                        <div class="row">
                            <div class="col-md-2">
                                <label class="label-required">{{ translate('City')}}</label>
                            </div>
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control mb-3 selectpicker" data-placeholder="{{ translate('Select your country')}}" name="city" required>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <label class="label-required">{{ translate('Address')}}</label>
                            </div>
                            <div class="col-md-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <input type="text" class="form-control mb-3" placeholder="{{ translate('Example: Postal Code For Ramallah is P613')}}" name="postal_code" value="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                                <label class="label-required">{{ translate('Phone')}}</label>
                            </div>
                            <div class="col-md-10">
                                <input type="tel" id="phone-code" pattern="[0-9]{9}" required class="pr-100 w-100 form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{  translate('599123456') }}" name="phone">
