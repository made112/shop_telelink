...
fields are hidden -->
<form method="POST" name="paymentForm" id="paymentForm" action="{{ config('visa.url') }}">
    @csrf
...
{{--            background-color: rgb(14, 69, 149);--}}
{{--        }--}}
{{--        .payment-title {--}}
{{--            width: 100%;--}}
{{--            text-align: center;--}}
...
{{--        <h1>Visa Payment Information</h1>--}}
{{--    </div>--}}
...
{{--        </div>--}}
{{--    </div>--}}
{{--    <form action="{{ route('visa.post')  }}" method="POST">--}}
{{--        @csrf--}}
...
{{--        <input type="hidden" name="PurchaseAmt" value="{{$formattedPurchaseAmt}}">--}}
...
{{--        <input type="hidden" name="Signature" value="{{$base64Sha1Signature}}">--}}
{{--        <input type="hidden" name="SignatureMethod" value="{{$signatureMethod}}">--}}

{{--        <div class="form-container">--}}
{{--            <div class="field-container">--}}
{{--                <label for="name">Name</label>--}}
{{--                <input id="name" name="" maxlength="20" type="text">--}}
{{--            </div>--}}
{{--            <div class="field-container">--}}
{{--                <label for="cardnumber">Card Number</label>--}}
{{--    --}}{{--            <span id="generatecard">generate random</span>--}}
{{--                <input id="cardnumber" name="merchantID" type="text" inputmode="numeric">--}}
...
{{--            </div>--}}
{{--        </div>--}}
{{--        <button class="btnx">{{ translate('Submit')  }}</button>--}}

{{--    </form>--}}
{{--    <script src="{{my_asset('frontend/js/imask.min.js')}}"></script>--}}
