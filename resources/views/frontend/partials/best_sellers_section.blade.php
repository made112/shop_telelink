            ...
            <div class="px-2 py-4 p-md-4 bg-white shadow-sm">
                <div class="section-title-1 clearfix">
                    ...
                    <ul class="inline-links float-lg-right nav mt-3 mb-2 m-lg-0 d-none d-lg-block">
                            <li><a href="javascript:void(0);">{{ translate('Top 20') }}</a></li>
                    </ul>
                </div>
                                ...
                                <div class="caorusel-card my-1">
                                    <div class="row no-gutters box-3 align-items-center border">
                                        <div class="col-4">
                                            <a href="{{ route('shop.visit', $seller->user->shop->slug) }}" class="d-block product-image p-3">
                                                <img
                                                    ...
                                                    data-src="@if ($seller->user->shop->logo !== null) {{ my_asset($seller->user->shop->logo) }} @else {{ my_asset('frontend/images/placeholder.jpg') }} @endif"
                                        ...
                                        <div class="col-8 border-left">
                                            <div class="p-3">
                                                <h2 class="product-title mb-0 p-0 text-truncate clearfix">
                                                    <a href="{{ route('shop.visit', $seller->user->shop->slug) }}" class="d-inline-block">{{ translate($seller->user->shop->name) }}</a>
                                                    <span class="float-right">{{ translate(convert_points_to_levels($points)) }}</span>
                                                </h2>
