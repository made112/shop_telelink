            ...
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                ...
                <div class="col-lg-9">
                    <div class="main-content">
                        ...
                        <form id="seller_profile_update" class="" action="{{ route('seller.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card bg-white mt-4">
                                <div class="card-header h6 mb-0 px-3 py-2">
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <input required type="text" class="form-control mb-3" placeholder="{{ translate('Your Name')}}" name="name" value="{{ Auth::user()->name }}">
                                        </div>
                                    </div>
{{--                                    <div class="row">--}}
{{--                                        <div class="col-md-2">--}}
...
@section('script')
    <script type="text/javascript">
        $(document).ready(function (){
            validateFile($('#seller_profile_update').find("input[name='photo']") ,['png','jpeg', 'jpg', 'svg']);
        })
        $('#seller_profile_update').submit(function (e){
            e.preventDefault();
            ...
            $.ajax({
                ...
                error: function (err) {
                    showFrontendAlert('danger', '{{translate('Sorry! Something went wrong, check fields.')}}');
                }
            });
        });
