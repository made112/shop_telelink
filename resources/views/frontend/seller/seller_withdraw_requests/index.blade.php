                    ...
                    <div class="main-content">
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="{{ route('withdraw_requests.index') }}">{{ translate('Money Withdraw')}}</a></li>
                                        </ul>
                                        <br>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 offset-md-2">
                                <div class="dashboard-widget text-center green-widget text-white mt-4 c-pointer">
                                    ...
                                    <span class="d-block sub-title">{{  translate('Pending Balance') }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="dashboard-widget text-center plus-widget mt-4 c-pointer" onclick="show_request_modal()">
                                    ...
                                    <span class="d-block title heading-6 strong-400 c-base-1">{{ translate('Send Withdraw Request') }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card no-border mt-5">
                            <div class="card-header py-3">
                                <h4 class="mb-0 h6">{{ translate('Withdraw Request history') }}</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($seller_withdraw_request->status == 1)
                                                            <span class="ml-2" style="color:green"><strong>{{ translate('SENT')}}</strong></span>
                                                        @else
                ...
                @if (Auth::user()->seller->admin_to_pay > 5)
                    <form class="" action="{{ route('withdraw_requests.store') }}" method="post">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-base-1">{{ translate('Send')}}</button>
                        </div>
                    </form>
                @else
                    <div class="modal-body gry-bg px-3 pt-3">
