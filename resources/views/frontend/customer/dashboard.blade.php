                                        ...
                                        @if(Auth::user()->addresses != null)
                                            ...
                                            @if($address != null)
                                                <ul class="list-unstyled mb-0">
                                                   ...
                                                   @if($address->country) <li class=" py-2"><span>{{ translate('Country') }} : {{ $address->country }}</span></li> @endif
                                                    <li class=" py-2"><span>{{ translate('City') }} : {{ getNameCity($address->city) }}</span></li>
