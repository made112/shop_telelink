                                ...
                                <div class="form-box-content p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 mb-3">
                                            <input type="text" class="form-control @if($errors->count() > 0 and !$errors->has('name')) is-valid @elseif($errors->has('name'))is-invalid @else '' @endif" placeholder="{{ translate('Shop Name')}}" name="name" >
                                            @error('name')
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label>{{ translate('Logo')}} <span class="required-star">*</span></label>
                                        </div>
                                        <div class="col-md-10 mb-3">
                                            ...
                                            <label for="file-2" class="mw-100 @if($errors->count() > 0 and !$errors->has('logo')) form-control is-valid @elseif($errors->has('logo')) form-control is-invalid @else '' @endif">
                                                <span></span>
                                                <strong>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 mb-3">
                                            <input type="text" class="form-control @if($errors->count() > 0 and !$errors->has('commercial_interest')) is-valid @elseif($errors->has('commercial_interest'))is-invalid @else '' @endif" placeholder="{{ translate('Commercial Interest')}}" name="commercial_interest" >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 mb-3">
                                            <input type="text" class="form-control @if($errors->count() > 0 and !$errors->has('address')) is-valid @elseif($errors->has('address'))is-invalid @else '' @endif" placeholder="{{ translate('Address')}}" name="address" >
                                            @error('address')
                                            <div class="text text-danger" style="margin-top: 3px;font-size: 10px;">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 mb-3">
                                            <input type="text" class="form-control @if($errors->count() > 0 and !$errors->has('phone')) is-valid @elseif($errors->has('phone'))is-invalid @else '' @endif" placeholder="{{ translate('Phone Number')}}" name="phone" >
                                            @error('phone')
                                            <div class="text text-danger" style="margin-top: 3px;font-size: 10px;">{{ $message }}</div>
                                            @enderror
                                        </div>
