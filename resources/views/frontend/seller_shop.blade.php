...
@section('content')
    ...
    @php
        ...
        $points = 0;
        foreach (\App\ClubPoint::where('user_id', $shop->user->id)->get('points') as $club) {
                ...
                <div class="col-md-6">
                    <div class="d-flex">
                        ...
                        <div class="pl-4">
                            ...
                            <div class="fb-share-button" data-href="{{ route('shop.visit', $shop->slug) }}" data-layout="button_count"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
