...
@section('meta')
    ...
    <meta itemprop="image" content="{{ my_asset(json_decode($detailedProduct->photos)[0]) }}" />
    ...
    <meta name="twitter:image" content="{{ my_asset(json_decode($detailedProduct->photos)[0]) }}" />
    ...
    <meta property="og:image" content="{{ my_asset(json_decode($detailedProduct->photos)[0]) }}" />
        ...
        <div class="container">
            ...
            <div class="bg-white">
                ...
                <div class="row no-gutters cols-xs-space cols-sm-space cols-md-space">
                    <div class="col-lg-5">
                        <div class="product-gal sticky-top d-flex flex-row-reverse flex-column">
{{--                            @php--}}
...
{{--                                        data-src="{{ my_asset($photos[0]) }}"--}}
{{--                                        xoriginal="{{ my_asset($photos[0]) }}"--}}
...
{{--                                </div>--}}
                            ...
                            @if(is_array(json_decode($detailedProduct->photos)) && count(json_decode($detailedProduct->photos)) > 0)
                                <div class="product-gal-img">
                                    <img src="{{ my_asset('frontend/images/placeholder.jpg') }}"
                                         onerror="this.onerror=null;this.src='{{ my_asset('frontend/images/placeholder.jpg') }}';"
                                         class="xzoom img-fluid lazyload" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset(json_decode($detailedProduct->photos)[0]) }}" xoriginal="{{ my_asset(json_decode($detailedProduct->photos)[0]) }}" />
                                </div>
                                <div class="product-gal-thumb">
                                    <div class="xzoom-thumbs">
                                        @foreach (json_decode($detailedProduct->photos) as $key => $photo)
                                            <a href="{{ my_asset($photo) }}">
                                                <img src="{{ my_asset('frontend/images/placeholder.jpg') }}" class="xzoom-gallery lazyload" src="{{ my_asset('frontend/images/placeholder.jpg') }}" width="80" data-src="{{ my_asset($photo) }}"
                                                     onerror="this.onerror=null;this.src='{{ my_asset('frontend/images/placeholder.jpg') }}';"
                                                     @if($key == 0) xpreview="{{ my_asset($photo) }}" @endif>
                                            </a>
                                        @endforeach
                        ...
                        <div class="product-description-wrapper">
                            ...
                            <div class="row align-items-center">
                                <div class="sold-by col-auto">
                                    ...
                                    @else
                                        <a href="{{ route('shop.uno') }}">{{ translate('UNO') }}</a>
                                    @endif
                                </div>
                                    ...
                                    <div class="col-10">
                                        <div class="product-quantity d-flex align-items-center">
                                            <div class="input-group input-group--style-2 pr-3" style="width: 160px;">
                                                ...
                                                <input type="text" name="quantity" class="form-control input-number text-center" placeholder="1" value="1" min="1" max="{{$qty}}">
                                                <span class="input-group-btn">
                                            ...
                                            <div class="avialable-amount">(<span id="available-quantity">@if($qty < 0 ) 0 @else {{$qty}} @endif</span> {{ translate('available')}})</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-2">
                        @php
                        $ads = \App\Ads::orderBy('created_at', 'desc')->select('link', 'photo')->first();
                        @endphp
                        @if($ads)
                        <a href="{{ $ads->link != '' ? $ads->link : '#' }}" target="_blank" class="d-block w-100 h-100 border-0 border-lg">
                            <img class="img-fit lazyload h-100 w-100" style="object-fit: cover" src="{{ my_asset('frontend/images/placeholder.jpg') }}" data-src="{{ my_asset($ads->photo) }}" alt="">
                        </a>
                        @endif
                    </div>
                </div>
    ...
    <section class="gry-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div class="mb-4 product-desc-tab bg-white">
                                    ...
                                    <div class="fluid-paragraph py-2">
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9 mb-5">
                                            @if ($detailedProduct->video_provider == 'youtube' && $detailedProduct->video_link != null)
                                                @php
                                                    $link = explode('=', $detailedProduct->video_link)[1];
                                                ...
                                                @endphp
                                                <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/{{ $link }}"></iframe>
                                            ...
                                            <div class="position-relative overflow-hidden h-100">
                                                <a href="{{ route('product', $related_product->slug) }}" class="d-block product-image h-100 text-center">
                                                    <img
                                                        ...
                                                        data-src="{{ my_asset($related_product->thumbnail_img) }}"
                                                        onerror="this.onerror=null;this.src='{{ my_asset('frontend/images/placeholder.jpg') }}';"
                                                        alt="{{  __($related_product->name) }}">
                                                </a>
                                            </div>
                                        </div>
                    ...
                    <div class="seller-top-products-box my-4 bg-white p-3">
                        <div class="section-title-1">
                            <h3 class="heading-5 strong-700 mb-0">
                                <span class="mr-4">{{ translate('Top Selling Products')}}</span>
                            </h3>
                        </div>
                            <div class="box-content caorusel-box arrow-round gutters-5">
                                    ...
                                    <div class="caorusel-card" style="width: 25%">
                                        <div class="product-box-2 bg-white alt-box my-2">
                                            <div class="position-relative overflow-hidden">
                                                <a href="{{ route('product', $top_product->slug) }}" class="d-block product-image h-100 text-center">
                                                    <img
                                                        class="img-fit lazyload"
                                                        src="{{ my_asset('frontend/images/placeholder.gif') }}"
                                                        data-src="{{ my_asset($top_product->thumbnail_img) }}"
                                                        onerror="this.onerror=null;this.src='{{ my_asset('frontend/images/placeholder.jpg') }}';"
                                                        alt="{{ __($top_product->name) }}">
                                                </a>
                                                <div class="product-btns clearfix">
                                                    <button class="btn add-wishlist" title="Add to Wishlist" onclick="addToWishList({{ $top_product->id }})" tabindex="0">
                                                        <i class="la la-heart-o"></i>
                                                    </button>
                                                    <button class="btn add-compare" title="Add to Compare" onclick="addToCompare({{ $top_product->id }})" tabindex="0">
                                                        <i class="la la-refresh"></i>
                                                    </button>
                                                    <button class="btn quick-view" title="Quick view" onclick="showAddToCartModal({{ $top_product->id }})" tabindex="0">
                                                        <i class="la la-eye"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="p-md-3 p-2">
                                                ...
                                                <h2 class="product-title p-0">
                                                    <a href="{{ route('product', $top_product->slug) }}" class=" text-truncate">{{ __($top_product->name) }}</a>
                                                </h2>
                                                @if (\App\Addon::where('unique_identifier', 'club_point')->first() != null && \App\Addon::where('unique_identifier', 'club_point')->first()->activated)
                        ...
                        <div class="form-group">
                            @php
                                ...
                                if($detailedProduct->thumbnail_img) {
                                    $img = explode('/',$detailedProduct->thumbnail_img)[2];
                                }
                            @endphp
                            <img
                                class="img-fit mx-auto lazyload w-100"
                                    ...
                                    <form class="form-default" role="form" action="{{ route('cart.login.submit') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group input-group--style-1">
                                                <input type="tel" required pattern="[0-9]{9}" id="phone-code" class="pl-100 w-100 form-control @error('phone') is-invalid @enderror" placeholder="{{  translate('Mobile Number') }}" name="phone">
                                                @error('phone')
