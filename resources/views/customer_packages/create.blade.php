            ...
            <form class="form-horizontal" action="{{ route('customer_packages.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" placeholder="{{translate('Name')}}" id="name" name="name" class="form-control @error('name') is-invalid @enderror" required>
                            @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0" step="0.01" placeholder="{{translate('Amount')}}" id="amount" name="amount" class="form-control @error('amount') is-invalid @enderror" required>
                            @error('amount')
                            <div class="text text-danger"
                                 style="margin-top: 3px;font-size: 10px;">{{ translate($message) }}</div>
                            @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" min="0" step="1" placeholder="{{translate('Product Upload')}}" id="product_upload" name="product_upload" class="form-control @error('product_upload') is-invalid @enderror" required>
