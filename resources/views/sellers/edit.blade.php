        ...
        <form class="form-horizontal" action="{{ route('sellers.update', $seller->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Name')}}" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{$seller->user->name}}" required>
                        @error('name')
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Email Address')}}" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{$seller->user->email}}">
                        @error('email')
                        <div class="text text-danger" style="margin-top: 3px;font-size: 10px;">{{ translate($message) }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="tel" required pattern="[0-9]{9}" id="phone-code" value="{{$seller->user->phone}}" class="border-right-0 h-auto w-100 form-control @error('phone') is-invalid @enderror" placeholder="{{  translate('Mobile Number') }}" name="phone">
                        @error('phone')
                        <div class="text text-danger" style="margin-top: 3px;font-size: 10px;">{{ translate($message) }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 position-relative">
                        <input type="password" placeholder="{{translate('Password')}}" id="password" value="{{ $seller->user->show_password }}" name="password" class="form-control @error('password') is-invalid @enderror" >
