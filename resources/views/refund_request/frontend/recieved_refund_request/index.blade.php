                    ...
                    <div class="main-content">
                        ...
                        <div class="card no-border mt-5">
                            <div class="card-header py-3">
                                <h4 class="mb-0 h6">{{ __('Refund Request') }}</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($refund->refund_status == 1)
                                                            <span class="ml-2 text-success"><strong>{{__('Approved')}}</strong></span>
                                                        @elseif ($refund->refund_status == -1)
                                                            <span class="ml-2 text-danger"><strong>{{__('Rejected')}}</strong></span>
                                                        @else
                                                            <span class="ml-2 text-warning"><strong>{{__('PENDING')}}</strong></span>
                                                        @endif
                                                    </td>
                                                    <td>
