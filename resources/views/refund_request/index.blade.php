...
<div class="panel">
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        ...
        <div class="pull-right clearfix">
            <form class="" id="sort_by_rating" action="{{ route('refund_requests_all') }}" method="GET">
                        ...
                        <td>
                            <div class="btn-group dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <li><a onclick="reject_request('{{ $refund->id }}')">{{__('Reject Request')}}</a></li>
...
@section('script')
    <script type="text/javascript">
        ...
        function reject_request(el){
            $.post('{{ route('reject_request_by_admin') }}',{_token:'{{ @csrf_token() }}', el:el}, function(data){
                if (data == 1) {
                    location.reload();
                    showAlert('success', 'Refund request has been rejected successfully');
                }
                else {
                    showAlert('danger', 'Something went wrong');
                }
