...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{translate('Visa Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    ...
                    @csrf
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="MERCHANT_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Merchat ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="MERCHANT_ID" value="{{  config('visa.merchantID') }}" placeholder="{{ translate('Merchant ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="ACQUIRER_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Acquirer ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="ACQUIRER_ID" value="{{  config('visa.acquirerID') }}" placeholder="{{ translate('Acquirer ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PASSWORD" value="{{  config('visa.password') }}" placeholder="{{ translate('Password') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="URL_REQUEST_VISA">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Request Url')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="URL_REQUEST_VISA" value="{{  config('visa.url') }}" placeholder="{{ translate('Request Url') }}" required>
                        </div>
                    </div>
    ...
    <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{translate('Jawwal Pay Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    <input type="hidden" name="payment_method" value="visa">
                    @csrf
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_MERCHANT_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Merchat ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_MERCHANT_ID" value="{{  config('jawwal-pay.merchantID') }}" placeholder="{{ translate('Merchant ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_IFRAME">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('IFrame')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_IFRAME" value="{{  config('jawwal-pay.iframe') }}" placeholder="{{ translate('IFrame') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_INTEGRATION_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Integration Payment ID')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_INTEGRATION_ID" value="{{  config('jawwal-pay.integrationID') }}" placeholder="{{ translate('Integration Payment ID') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_USERNAME">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Username')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_USERNAME" value="{{  config('jawwal-pay.username') }}" placeholder="{{ translate('Username') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_PASSWORD">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Password')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_PASSWORD" value="{{  config('jawwal-pay.password') }}" placeholder="{{ translate('Password') }}" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="PAY_HOSTNAME">
                        <div class="col-lg-3">
                            <label class="control-label">{{translate('Hostname')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="PAY_HOSTNAME" value="{{  config('jawwal-pay.hostname') }}" placeholder="{{ translate('Hostname') }}" required>
                        </div>
                    </div>
