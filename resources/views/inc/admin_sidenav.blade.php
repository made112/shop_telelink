                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['products.create'])}}">
                                        <a class="nav-link" href="{{ route('products.create')}}">{{translate('Add New Product')}}</a>
                                    </li>
                                    ...
                                    <li class="{{ areActiveRoutes(['products.admin', 'products.admin.edit'])}}">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('16', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="{{ areActiveRoutes(['sponsored_products.index', 'sponsored_products.create', 'sponsored_products.edit'])}}">
                                <a class="nav-link" href="{{ route('sponsored_products.index') }}">
                                    <i class="fa fa-list"></i>
                                    <span class="menu-title">{{translate('Sponsored Products')}}</span>
                                </a>
                            </li>
                        @endif
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li class="{{ areActiveRoutes(['refund_requests_all', 'reason_show'])}}">
                                        <a class="nav-link" href="{{route('refund_requests_all')}}">{{translate('Refund Requests')}}
                                    ...
                                    <li class="{{ areActiveRoutes(['rejected_refund'])}}">
                                        <a class="nav-link" href="{{route('rejected_refund')}}">{{translate('Rejected Refund')}}</a>
                                    </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['business_settings.vendor_levels'])}}">
                                    <a class="nav-link" href="{{ route('business_settings.vendor_levels') }}">{{translate('Seller Levels')}}</a>
                                </li>
                        ...
                        @php
                            $conversation = \App\Conversation::where('receiver_id', Auth::user()->id)->where('receiver_viewed', '0')->get();
                        @endphp
                        ...
                        @if(\App\BusinessSetting::where('type', 'bisan_system')->first()->value == 1)
                        <li>
                            <a href="#">
                                <i class="fa fa-plus-square"></i>
                                <span class="menu-title">{{translate('Bisan System')}}</span>
                                <i class="arrow"></i>
                            </a>

{{--                            <!--Submenu-->--}}
                            <ul class="collapse">
                                <li class="{{ areActiveRoutes(['bisan.export_products'])}}">
                                    <a class="nav-link" href="{{ route('bisan.export_products') }}">{{translate('Export Products')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['bisan.export_orders'])}}">
                                    <a class="nav-link" href="{{ route('bisan.export_orders') }}">{{translate('Export Orders')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['bisan.configure'])}}">
                                    <a class="nav-link" href="{{ route('bisan.configure') }}">{{translate('Configuration')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['preferred_products.index'])}}">
                                    <a class="nav-link" href="{{ route('preferred_products.index') }}">{{translate('Preferred Products Report')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['best_categories.index'])}}">
                                    <a class="nav-link" href="{{ route('best_categories.index') }}">{{translate('Best Categories Report')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['wish_report.index'])}}">
                                    <a class="nav-link" href="{{ route('wish_report.index') }}">{{translate('Product Wish Report')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['cancelled_orders.index'])}}">
                                    <a class="nav-link" href="{{ route('cancelled_orders.index') }}">{{translate('Cancelled Orders Report')}}</a>
                                </li>
                                <li class="{{ areActiveRoutes(['sales_report.index'])}}">
                                    <a class="nav-link" href="{{ route('sales_report.index') }}">{{translate('Products Sales Report')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
...
{{--                                </li>--}}
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['unit.index'])}}">
                                    <a class="nav-link" href="{{route('unit.index')}}">{{translate('Unit')}}</a>
                                </li>
                        ...
                        <li>
                            ...
                            <ul class="collapse">
                                ...
                                <li class="{{ areActiveRoutes(['cities.index','cities.edit','cities.update'])}}">
                                    <a class="nav-link" href="{{route('cities.index')}}">{{translate('Shipping Cities')}}</a>
                                </li>
                            </ul>
                        </li>
                        @endif
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['offline_wallet_recharge_request.index'])}}">
                                        <a class="nav-link" href="{{ route('offline_wallet_recharge_request.index') }}">{{translate('Offline Wallet Recharge')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if (\App\Addon::where('unique_identifier', 'otp_system')->first() != null)
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="{{ areActiveRoutes(['otp.logger'])}}">
                                        <a class="nav-link" href="{{route('otp.logger')}}">{{translate('OTP Logger')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
