<div class="modal fade" id="aizUploaderModal" data-backdrop="static" role="dialog" aria-hidden="true" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="uppy-modal-nav">
                    <ul class="nav nav-tabs border-0">
                        <li class="nav-item active">
                            <a class="nav-link font-weight-medium text-dark" data-toggle="tab" onclick="enableBtnAddFiles(this)" href="#aiz-select-file">{{ translate('Select File') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link font-weight-medium text-dark" data-toggle="tab" onclick="disableBtnAddFiles(this)" href="#aiz-upload-new">{{ translate('Upload New') }}</a>
                        </li>
                    </ul>
                </div>
...
{{--                                <div class="co"></div>--}}
                                <div class="col-md-4 col-md-push-2 col-xl-3 ml-auto col-2 position-static">
            ...
            <div class="modal-footer justify-content-between bg-light">
                ...
                <span id="txt_msg" class="mar-rgt"></span>
