...
@section('content')
    ...
    <div class="pad-all text-center clearfix">
        <form class="" style="display: inline-block" action="{{ route('in_house_sale_report.index') }}" method="GET">
        ...
        <div class="select clearfix float-right mar-lft" style="width: 150px;">
            <form id="formExport" action="{{ route('in_house_sale_report.download')}}" method="GET">
                @csrf
