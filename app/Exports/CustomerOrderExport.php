...
class CustomerOrderExport implements FromQuery, WithHeadings, ShouldAutoSize, WithEvents, WithMapping
{
    public function __construct($orderDt)
    {
    ...
    {
        return OrderDetail::query()->where('id', $this->orderDt);
    }
