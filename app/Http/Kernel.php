...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\onenter::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        'verified_phone' => EnsurePhoneVerified::class,
        'changeLocale'=> \App\Http\Middleware\changeLocaleApi::class,
        'hasPermission' => \App\Http\Middleware\hasPermission::class,
        'sellerLogin' => \App\Http\Middleware\SellerLogin::class,
